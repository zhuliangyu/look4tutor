...
RSpec.describe TutorsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested tutor as @tutor" do
      tutor = Tutor.create! valid_attributes
      get :show, params: {id: tutor.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested tutor as @tutor" do
      tutor = Tutor.create! valid_attributes
      get :edit, params: {id: tutor.to_param}, session: valid_session
      expect(assigns(:tutor)).to eq(tutor)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Tutor" do
        expect {
          post :create, params: {tutor: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved tutor as @tutor" do
        post :create, params: {tutor: invalid_attributes}, session: valid_session
        expect(assigns(:tutor)).to be_a_new(Tutor)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tutor" do
        tutor = Tutor.create! valid_attributes
        put :update, params: {id: tutor.to_param, tutor: new_attributes}, session: valid_session
        tutor.reload
      ...
      it "assigns the requested tutor as @tutor" do
        tutor = Tutor.create! valid_attributes
        put :update, params: {id: tutor.to_param, tutor: valid_attributes}, session: valid_session
        expect(assigns(:tutor)).to eq(tutor)
      end
    ...
    context "with invalid params" do
      it "assigns the tutor as @tutor" do
        tutor = Tutor.create! valid_attributes
        put :update, params: {id: tutor.to_param, tutor: invalid_attributes}, session: valid_session
        expect(assigns(:tutor)).to eq(tutor)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested tutor" do
      tutor = Tutor.create! valid_attributes
      expect {
        delete :destroy, params: {id: tutor.to_param}, session: valid_session
      }.to change(Tutor, :count).by(-1)
    end
